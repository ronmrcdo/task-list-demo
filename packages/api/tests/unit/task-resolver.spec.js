...
describe('TaskResolver', () => {
    ...
    it('should call createTask and resolve task', async () => {
        ...
        const actual = await resolvers.Mutation.createTask({}, { note: mockTasks[0].note }, mockContext);
    ...
    it('should call deleteTask and resolve boolean', async () => {
        ...
        const actual = await resolvers.Mutation.deleteTask({}, { id: mockTasks[0].id }, mockContext);
